Main purpose of this project if to figure out if a correlation exists between the different attributes that are in the dataset and explore different visual representations.
